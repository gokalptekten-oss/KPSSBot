...
{t:"İslamiyet Öncesi Türk Devletleri",q:"Aşağıdakilerden hangisi Uygurların diğer Türk devletlerinden farklı bir özelliğidir?",o:{"A":"Göçebe yaşam sürdürmeleri","B":"Yerleşik hayata geçerek şehirler kurmaları","C":"Demir işleme teknolojisini geliştirmeleri","D":"Kurultay meclisi oluşturmaları","E":"Töre geleneğini sürdürmeleri"},a:"B",e:"Uygurlar, yerleşik hayata geçen, matbaa ve kağıdı kullanan ilk Türk devletidir.",d:"Uygur farklılıkları: Maniheizm/Budizm, matbaa, hareketli harf, kâğıt para. Göçebeliği bırakmaları tarım ve ticareti öne çıkarmıştır."},
{t:"Osmanlı Kuruluş Dönemi",q:"Osmanlı Devleti'nde devşirme sistemiyle yetiştirilen askeri birlik aşağıdakilerden hangisidir?",o:{"A":"Akıncılar","B":"Sipahiler","C":"Yeniçeriler","D":"Azaplar","E":"Deliler"},a:"C",e:"Yeniçeriler, devşirme sistemiyle Hristiyan ailelerden alınan çocukların yetiştirilmesiyle oluşturulan kapıkulu ocağıdır.",d:"Yeniçeriler I. Murad döneminde kuruldu. Devşirme = gayrimüslim ailelerin çocukları. Kapıkulu askerleri maaşlı, padişaha bağlı. Tımarlı sipahiler ise toprak geliriyle geçinir. Bu ayrım KPSS'de sık sorulur."},
{t:"Osmanlı Gerileme ve Dağılma",q:"III. Selim döneminde kurulan ve Avrupa tarzı eğitim verilen yeni orduya ne ad verilmiştir?",o:{"A":"Sekban-ı Cedit","B":"Nizam-ı Cedit","C":"İrad-ı Cedit","D":"Eşkinci Ocağı","E":"Mansure Ordusu"},a:"B",e:"Nizam-ı Cedit (Yeni Düzen), III. Selim'in kurduğu Avrupa tarzı modern ordudur.",d:"III. Selim ıslahatları: Nizam-ı Cedit ordusu + İrad-ı Cedit hazinesi + Avrupa'ya daimi elçiler. Kabakçı Mustafa İsyanı ile devrildi. Mansure = II. Mahmud'un Vaka-i Hayriye sonrası kurduğu ordu."},
{t:"Tanzimat ve Meşrutiyet",q:"II. Meşrutiyet'in (1908) ilanını sağlayan örgüt aşağıdakilerden hangisidir?",o:{"A":"Genç Osmanlılar","B":"Muhafaza-i Mukaddesat Cemiyeti","C":"İttihat ve Terakki Cemiyeti","D":"Müdafaa-i Hukuk Cemiyeti","E":"Felah-ı Vatan Grubu"},a:"C",e:"II. Meşrutiyet, İttihat ve Terakki Cemiyeti'nin baskısıyla II. Abdülhamid tarafından ilan edilmiştir.",d:"I. Meşrutiyet = Genç Osmanlılar. II. Meşrutiyet = İttihat ve Terakki. Bu ayrım KPSS'de her yıl sorulur. İttihat ve Terakki 1908-1918 arası fiilen iktidardır."},
{t:"Kurtuluş Savaşı Hazırlık",q:"Sivas Kongresi'nin (4-11 Eylül 1919) en önemli kararı aşağıdakilerden hangisidir?",o:{"A":"Düzenli ordunun kurulması","B":"Tüm millî cemiyetlerin birleştirilmesi","C":"Saltanatın kaldırılması","D":"Cumhuriyetin ilan edilmesi","E":"Halifeliğin kaldırılması"},a:"B",e:"Sivas Kongresi'nde tüm millî cemiyetler 'Anadolu ve Rumeli Müdafaa-i Hukuk Cemiyeti' adı altında birleştirilmiştir.",d:"Sivas Kongresi = ulusal kongre, tüm vatanı temsil eder. En önemli karar: Cemiyetlerin birleşmesi + Temsil Heyeti'nin tüm vatanı temsil yetkisi alması. Erzurum = bölgesel, Sivas = ulusal."},
{t:"TBMM ve Muharebeler",q:"Büyük Taarruz (26 Ağustos 1922) sonucunda imzalanan ateşkes antlaşması aşağıdakilerden hangisidir?",o:{"A":"Mondros Mütarekesi","B":"Mudanya Mütarekesi","C":"Lozan Antlaşması","D":"Ankara Antlaşması","E":"Moskova Antlaşması"},a:"B",e:"Büyük Taarruz sonrası 11 Ekim 1922'de Mudanya Mütarekesi imzalanmıştır.",d:"Sıralama: Büyük Taarruz (Ağustos) → Dumlupınar (30 Ağustos Zafer Bayramı) → Mudanya Mütarekesi (11 Ekim) → Saltanatın kaldırılması (1 Kasım) → Lozan (24 Temmuz 1923)."},
{t:"Atatürk İlkeleri ve İnkılapları",q:"Tevhid-i Tedrisat Kanunu (1924) ile aşağıdakilerden hangisi amaçlanmıştır?",o:{"A":"Vergide birlik","B":"Eğitimde birlik","C":"Hukukta birlik","D":"Orduda birlik","E":"Ekonomide birlik"},a:"B",e:"Tevhid-i Tedrisat (Öğretim Birliği) Kanunu ile tüm eğitim kurumları Milli Eğitim Bakanlığı'na bağlanmıştır.",d:"Tevhid-i Tedrisat = Laiklik ilkesi. Medreseler kapatıldı, tek tip eğitim sistemi kuruldu. Eğitimde birlik = toplumda birlik. KPSS'de hem Tarih hem Vatandaşlık'ta çıkar."},
{t:"Çağdaş Türk ve Dünya Tarihi",q:"Birleşmiş Milletler (BM) hangi yılda ve hangi amaçla kurulmuştur?",o:{"A":"1945 — Dünya barışını korumak","B":"1949 — Ekonomik kalkınma","C":"1955 — Soğuk Savaş'ı bitirmek","D":"1920 — Sömürgeciliği önlemek","E":"1939 — Savaşı durdurmak"},a:"A",e:"BM, 1945'te II. Dünya Savaşı sonrasında uluslararası barış ve güvenliği korumak amacıyla kurulmuştur.",d:"BM = 1945 San Francisco. Milletler Cemiyeti = 1920 (başarısız oldu). Türkiye BM kurucu üyesidir. BM Güvenlik Konseyi 5 daimi üye: ABD, Rusya, Çin, İngiltere, Fransa."},
{t:"Osmanlı Duraklama ve Islahatlar",q:"Osmanlı tarihinde 'Lale Devri' olarak bilinen dönemin sona erme nedeni aşağıdakilerden hangisidir?",o:{"A":"Rusya'nın saldırması","B":"Patrona Halil İsyanı","C":"Yeniçeri Ocağı'nın kaldırılması","D":"Tanzimat Fermanı'nın ilanı","E":"I. Dünya Savaşı"},a:"B",e:"Lale Devri (1718-1730), Patrona Halil İsyanı ile sona ermiştir.",d:"Lale Devri = III. Ahmed + Nevşehirli Damat İbrahim Paşa. İsyanın sebebi: Halkın aşırı lüks ve eğlenceye tepkisi + İran savaşındaki başarısızlık."},
],
turkce:[
...
{t:"Sözcükte Anlam",q:"Aşağıdaki cümlelerin hangisinde 'düşmek' sözcüğü gerçek anlamıyla kullanılmıştır?",o:{"A":"Sınavda düşük not aldı.","B":"Fiyatlar son günlerde düştü.","C":"Çocuk bisikletten düştü.","D":"Aklına güzel bir fikir düştü.","E":"Kardeşler birbirine düştü."},a:"C",e:"'Bisikletten düşmek' fiziksel olarak düşmeyi ifade eder — gerçek anlam.",d:"Gerçek anlam = sözcüğün ilk, temel anlamı. Diğerlerinde not düşmek, fiyat düşmek, fikir düşmek, birbirine düşmek = hep mecaz."},
{t:"Cümlede Anlam",q:"'Ağaç yaşken eğilir.'\n\nBu atasözüyle anlatılmak istenen aşağıdakilerden hangisidir?",o:{"A":"Yaşlı ağaçlar daha güçlüdür.","B":"Eğitim küçük yaşta verilmelidir.","C":"Ağaçlar rüzgârda eğilir.","D":"Her şeyin bir zamanı vardır.","E":"Doğa korunmalıdır."},a:"B",e:"Atasözü mecazlıdır: Ağaç = insan, yaşken = küçükken, eğilir = şekillenir/eğitilir.",d:"KPSS'de atasözü yorumlama soruları gelir. Somut ifadeyi soyuta çevir."},
{t:"Paragraf Yorumlama",q:"Bir paragrafta örnekler verilip sonunda genel bir yargıya ulaşılıyorsa bu anlatım biçimi aşağıdakilerden hangisidir?",o:{"A":"Tümdengelim","B":"Tümevarım","C":"Betimleme","D":"Tartışma","E":"Öyküleme"},a:"B",e:"Özelden genele gidiş = tümevarım.",d:"Tümevarım = özel → genel. Tümdengelim = genel → özel. KPSS'de paragraf yapısı tanıma sorusu sık gelir."},
{t:"Sözcük Türleri",q:"'Küçük çocuk büyük bir sevinçle koşuyordu.'\n\nBu cümlede kaç sıfat vardır?",o:{"A":"1","B":"2","C":"3","D":"4","E":"Sıfat yoktur"},a:"C",e:"'Küçük' (niteleme), 'büyük' (niteleme), 'bir' (belgisiz) — 3 sıfat.",d:"'Bir' hem sayı sıfatı hem belgisiz sıfat olabilir. Burada 'herhangi bir' anlamında belgisiz."},
{t:"Cümle Ögeleri",q:"'Annesi, çocuğa güzel bir hediye aldı.'\n\nBu cümlede 'güzel bir hediye' hangi ögedir?",o:{"A":"Özne","B":"Belirtisiz nesne","C":"Belirtili nesne","D":"Dolaylı tümleç","E":"Zarf tümleci"},a:"B",e:"'Güzel bir hediye' belirtisiz nesnedir. 'Ne aldı?' sorusuna cevap verir.",d:"Belirtili nesne: -ı/-i eki alır. Belirtisiz nesne: ek almaz. 'Ne?' → belirtisiz. 'Neyi?' → belirtili."},
{t:"Anlatım Bozuklukları",q:"'Yaklaşık 50 kadar kişi toplantıya katıldı.'\n\nBu cümledeki anlatım bozukluğu nedir?",o:{"A":"Özne eksikliği","B":"Yüklem eksikliği","C":"Gereksiz sözcük kullanımı","D":"Tamlama yanlışı","E":"Çatı uyumsuzluğu"},a:"C",e:"'Yaklaşık' ve 'kadar' aynı anlama gelir, biri gereksizdir.",d:"'Yaklaşık 50 kadar' → 'yaklaşık 50' veya '50 kadar' yeterli. Benzer: 'ilk önce', 'en son sonuç'."},
{t:"Sözel Mantık",q:"Ali'den uzun olan herkes Veli'den de uzundur. Mehmet, Ali'den uzundur.\n\nBuna göre hangisi kesinlikle doğrudur?",o:{"A":"Ali en kısa kişidir.","B":"Mehmet Veli'den uzundur.","C":"Veli Ali'den uzundur.","D":"Ali Veli'den kısadır.","E":"Herkes aynı boydadır."},a:"B",e:"Mehmet Ali'den uzun → Ali'den uzun herkes Veli'den uzun → Mehmet Veli'den uzundur.",d:"Koşullu önerme zinciri. KPSS'de basit mantık sorusu."},
{t:"Cümlede Anlam",q:"'Ne kadar çok okursan o kadar çok bilirsin.'\n\nBu cümlede hangi anlam ilişkisi vardır?",o:{"A":"Karşıtlık","B":"Koşul-sonuç","C":"Neden-sonuç","D":"Amaç-sonuç","E":"Doğru orantı"},a:"E",e:"'Ne kadar...o kadar' yapısı doğru orantı bildirir.",d:"'Ne kadar...o kadar' = doğru orantı. 'Rağmen' = karşıtlık. 'İçin/diye' = amaç. '-dıkça' = koşul."},
{t:"Yazım Kuralları",q:"Aşağıdaki cümlelerin hangisinde 'de/da' bağlacının yazımı yanlıştır?",o:{"A":"Sen de gel istersen.","B":"Evde kimse yoktu.","C":"Bende bu kitap var.","D":"O da seninle gelsin.","E":"Bahçede çiçekler açmış."},a:"C",e:"'Bende' değil, 'Ben de' olmalıdır.",d:"De/da ayrımı: Cümleden çıkarılınca anlam bozulmazsa bağlaç → ayrı yazılır."},
{t:"Sözcükte Anlam",q:"Aşağıdaki cümlelerin hangisinde ad aktarması (mecazımürsel) vardır?",o:{"A":"Yüreği sızladı.","B":"Ankara bu karara karşı çıktı.","C":"Güzel sözler söyledi.","D":"Dağlar yeşile büründü.","E":"Hava bugün çok soğuk."},a:"B",e:"'Ankara' derken Ankara'daki hükümet/yetkililer kastediliyor — yer adı, orada bulunanlar yerine kullanılmış.",d:"Ad aktarması (mecazımürsel): Bir sözcüğü benzetme amacı olmadan başka bir sözcük yerine kullanma. 'Ankara' = hükümet. 'Saray' = padişah. 'Ocak söndü' = aile yok oldu. Mecazdan farkı: benzetme yok."},
{t:"Paragraf Yorumlama",q:"Bir paragrafın sonuç cümlesini bulmak için aşağıdakilerden hangisine bakılmalıdır?",o:{"A":"En uzun cümleye","B":"En çok tekrar eden sözcüğe","C":"Yazarın vardığı yargıya veya çıkarıma","D":"İlk cümledeki bağlaca","E":"Paragraftaki soru cümlesine"},a:"C",e:"Sonuç cümlesi, yazarın konuyu değerlendirip vardığı yargıdır.",d:"Sonuç cümlesi genellikle paragrafın sonunda yer alır ama her zaman değil. 'Demek ki', 'sonuç olarak', 'bu nedenle' gibi ifadeler sonuç cümlesi ipucudur. Ana düşünceden farklıdır — ana düşünce daha genel."},
],
matematik:[
...
{t:"Hız-Zaman-Yol",q:"A şehrinden B şehrine giden bir araç gidiş yolculuğunu 80 km/h, dönüş yolculuğunu 120 km/h hızla yapmıştır.\n\nBu aracın gidiş-dönüş ortalama hızı kaç km/h'tir?",o:{"A":"96","B":"100","C":"104","D":"108","E":"110"},a:"A",e:"Ortalama hız = 2 × v₁ × v₂ / (v₁ + v₂) = 96 km/h.",d:"DİKKAT: Ortalama hız ≠ hızların ortalaması! Doğru formül: 2v₁v₂/(v₁+v₂)."},
{t:"Sayı Problemleri",q:"Bir sayının 4 katından 7 çıkarılırsa 25 elde ediliyor. Bu sayı kaçtır?",o:{"A":"6","B":"7","C":"8","D":"9","E":"10"},a:"C",e:"4x - 7 = 25 → 4x = 32 → x = 8.",d:"Sözel → denklem dönüşümü: '4 katından' = 4x, '7 çıkarılırsa' = -7, '25 elde ediliyor' = =25."},
{t:"Oran-Orantı",q:"Bir haritada 3 cm, gerçekte 15 km'ye karşılık geliyor. Haritada 7 cm olan iki şehir arası gerçekte kaç km'dir?",o:{"A":"25","B":"30","C":"35","D":"40","E":"45"},a:"C",e:"3 cm → 15 km, 1 cm → 5 km, 7 cm → 35 km.",d:"Doğru orantı: 3/15 = 7/x → x = 35. Harita ölçek sorusu hem Matematik hem Coğrafya'da çıkar."},
{t:"Yüzde Problemleri",q:"Bir sınıfta 40 öğrenci vardır. Sınavda %60'ı geçmiştir. Geçen öğrenci sayısı kaçtır?",o:{"A":"20","B":"22","C":"24","D":"26","E":"28"},a:"C",e:"40 × 60/100 = 24.",d:"Yüzde hesabı: Sayı × Yüzde/100. KPSS'de genellikle ters yüzde de sorulur: '24 kişi geçtiyse yüzde kaçı geçti?'"},
{t:"Kümeler",q:"Bir sınıfta 30 öğrenci var. 18'i futbol, 15'i basketbol seviyor. Her iki sporu da seven 8 öğrenci varsa yalnız futbol seven kaç kişidir?",o:{"A":"7","B":"8","C":"10","D":"12","E":"15"},a:"C",e:"Yalnız futbol = 18 - 8 = 10.",d:"Venn şeması: Futbol dairesinden kesişimi çıkar. s(A∪B) = s(A) + s(B) - s(A∩B). Hiçbirini sevmeyen = 30 - (18+15-8) = 5."},
{t:"İşçi-Havuz",q:"Bir havuzu A musluğu 8 saatte, B musluğu 12 saatte dolduruyor. İkisi birlikte açılırsa havuz kaç saatte dolar?",o:{"A":"4","B":"4.8","C":"5","D":"5.5","E":"6"},a:"B",e:"1/8 + 1/12 = 3/24 + 2/24 = 5/24. Toplam: 24/5 = 4.8 saat.",d:"İşçi-havuz mantığı aynı: hızları topla. 1/8 + 1/12 = 5/24 → 24/5 = 4.8 saat. Ondalık sonuç çıkabilir, KPSS buna hazırlıklı ol."},
{t:"Geometri",q:"Bir karenin alanı 64 cm² ise çevresi kaç cm'dir?",o:{"A":"24","B":"28","C":"32","D":"36","E":"40"},a:"C",e:"Alan = a² = 64 → a = 8. Çevre = 4a = 32 cm.",d:"Kare: Alan = a², Çevre = 4a. a = √Alan. Dikdörtgen: Alan = a×b, Çevre = 2(a+b). Karıştırma!"},
{t:"İstatistik ve Olasılık",q:"3, 5, 5, 7, 9, 11 sayılarının medyanı kaçtır?",o:{"A":"5","B":"6","C":"7","D":"8","E":"9"},a:"B",e:"6 sayı var, ortadaki iki sayının ortalaması: (5+7)/2 = 6.",d:"Çift adette medyan: Ortadaki iki sayının ortalaması. Tek adette: Ortadaki sayının kendisi. Sıralama şart!"},
{t:"Denklem ve Eşitsizlik",q:"2(x + 3) = 5x - 6 denklemini sağlayan x değeri kaçtır?",o:{"A":"2","B":"3","C":"4","D":"5","E":"6"},a:"C",e:"2x + 6 = 5x - 6 → 12 = 3x → x = 4.",d:"Parantez açmayı unutma! 2(x+3) = 2x + 6, sonra bilinmeyenleri topla."},
{t:"Yaş Problemleri",q:"Bir anne kızından 28 yaş büyüktür. 6 yıl önce annenin yaşı kızının yaşının 5 katıydı. Kızın şimdiki yaşı kaçtır?",o:{"A":"11","B":"12","C":"13","D":"14","E":"15"},a:"C",e:"Kız: x, Anne: x+28. 6 yıl önce: (x+22) = 5(x-6) → x+22 = 5x-30 → 52 = 4x → x = 13.",d:"Yaş farkı sabittir: Şimdi 28 fark, geçmişte de 28 fark, gelecekte de. '6 yıl önce' = her yaştan 6 çıkar."},
{t:"Sayı Problemleri",q:"3 ile tam bölünebilen en küçük üç basamaklı sayı kaçtır?",o:{"A":"100","B":"101","C":"102","D":"103","E":"105"},a:"C",e:"100 → 1+0+0=1 (bölünmez). 101 → 2 (bölünmez). 102 → 1+0+2=3 (bölünür).",d:"Bölünebilme kuralları: 3'e bölünme = rakamlar toplamı 3'ün katı. 9'a bölünme = rakamlar toplamı 9'un katı. 4'e = son iki rakam. 8'e = son üç rakam. KPSS'de sık sorulan konu."},
],
cografya:[
...
{t:"İklim ve Bitki Örtüsü",q:"Türkiye'de fön rüzgârının etkisiyle aşağıdaki olaylardan hangisi meydana gelir?",o:{"A":"Kar yağışının artması","B":"Rüzgârın estiği yamaçta sıcaklığın artması ve nemin azalması","C":"Deniz suyu sıcaklığının düşmesi","D":"Bulut oluşumunun artması","E":"Bitki örtüsünün gürleşmesi"},a:"B",e:"Fön rüzgârı, dağın rüzgâr altı yamacında sıcaklığı artırıp nemi azaltır.",d:"Fön etkisi: Nemli hava dağa çarpar → soğur → yağış → dağı aşınca sıcak ve kuru iner."},
{t:"Harita Bilgisi",q:"Eş yükselti eğrileri arasındaki mesafenin az olduğu yerlerde aşağıdakilerden hangisi söylenebilir?",o:{"A":"Düzlük alan fazladır","B":"Eğim azdır","C":"Eğim fazladır","D":"Yükseklik azdır","E":"Yağış fazladır"},a:"C",e:"Eş yükselti eğrileri sık ise yamaç diktir, eğim fazladır.",d:"Eğri sık = dik yamaç. Eğri seyrek = az eğimli/düz alan. Bu bilgi harita yorumlama sorularında temel."},
{t:"Türkiye Yer Şekilleri",q:"Aşağıdakilerden hangisi Türkiye'deki akarsu aşınım şekillerinden biridir?",o:{"A":"Delta ovası","B":"Birikinti konisi","C":"Vadi","D":"Traverten","E":"Kıyı oku"},a:"C",e:"Vadi, akarsuyun yatağını derinleştirmesiyle oluşan aşınım şeklidir.",d:"Aşınım şekilleri: Vadi, kanyon, dev kazanı, peribacası. Birikim şekilleri: Delta, birikinti konisi, ova. KPSS'de ayrımı sorulur."},
{t:"Nüfus ve Yerleşme",q:"Aşağıdakilerden hangisi Türkiye'de nüfus artış hızının düşmesinin nedenlerinden biri değildir?",o:{"A":"Aile planlaması uygulamaları","B":"Kadınların iş hayatına katılması","C":"Eğitim düzeyinin yükselmesi","D":"Kırdan kente göçün artması","E":"Salgın hastalıkların yaygınlaşması"},a:"E",e:"Salgın hastalıklar nüfus artış hızını düşüren planlı bir neden değildir.",d:"Nüfus artış hızı düşüş nedenleri: Aile planlaması, eğitim, kentleşme, kadın istihdamı, ekonomik kaygılar. Salgın = doğal nüfus kaybı, planlı azalma değil."},
{t:"Türkiye Tarım ve Hayvancılık",q:"Aşağıdaki hayvan türlerinden hangisi Türkiye'de en çok Doğu Anadolu Bölgesi'nde yetiştirilir?",o:{"A":"İpek böceği","B":"Arı","C":"Büyükbaş hayvan (sığır)","D":"Kümes hayvanları","E":"Deve"},a:"C",e:"Doğu Anadolu'nun geniş otlak ve yaylaları büyükbaş hayvancılığa uygundur.",d:"Bölge-hayvan eşleştirmesi: Doğu Anadolu = büyükbaş (geniş otlaklar). İç Anadolu = küçükbaş (koyun, keçi). Marmara = kümes hayvanı. Güneydoğu = kıl keçisi."},
{t:"Madenler ve Enerji",q:"Türkiye'de taşkömürü çıkarılan başlıca il aşağıdakilerden hangisidir?",o:{"A":"Eskişehir","B":"Batman","C":"Zonguldak","D":"Muğla","E":"Afyon"},a:"C",e:"Türkiye'de taşkömürü yalnızca Zonguldak ve çevresinde (Ereğli, Bartın) çıkarılır.",d:"Taşkömürü = Zonguldak. Linyit = Muğla, Manisa, Afyon (yaygın). Petrol = Batman, Diyarbakır. Krom = Muğla. Bu tek-il eşleştirmeleri ezberle."},
{t:"Bölgeler Coğrafyası",q:"Aşağıdaki bölgelerden hangisinde arazinin engebeli olması nedeniyle ulaşım en zor gerçekleşir?",o:{"A":"Marmara","B":"İç Anadolu","C":"Doğu Anadolu","D":"Güneydoğu Anadolu","E":"Ege"},a:"C",e:"Doğu Anadolu yüksek dağları ve sert kış koşullarıyla ulaşımın en zor olduğu bölgedir.",d:"Doğu Anadolu: En yüksek ortalama yükselti, en sert kış, en uzun kar örtüsü süresi. Bunların hepsi ulaşımı zorlaştırır."},
{t:"İklim ve Bitki Örtüsü",q:"Türkiye'de maki bitki örtüsü en yaygın hangi bölgede görülür?",o:{"A":"Karadeniz","B":"İç Anadolu","C":"Akdeniz","D":"Doğu Anadolu","E":"Güneydoğu Anadolu"},a:"C",e:"Maki, Akdeniz ikliminin doğal bitki örtüsüdür.",d:"Akdeniz = maki + garig. Karadeniz = orman. İç Anadolu = bozkır. Doğu Anadolu = dağ çayırları."},
{t:"Harita Bilgisi",q:"Bir haritada kuzeyi belirlemek için aşağıdakilerden hangisi kullanılır?",o:{"A":"Ölçek","B":"Lejant","C":"Yön oku (pusula gülü)","D":"Eş yükselti eğrisi","E":"Koordinat"},a:"C",e:"Yön oku (pusula gülü/kuzey oku) haritada yönü belirlemek için kullanılır.",d:"Harita unsurları: Başlık, ölçek, lejant (açıklama), yön oku. Yön oku yoksa haritanın üstü kuzeydir (genel kural). Bu temel bilgi KPSS'de doğrudan sorulur."},
{t:"Türkiye Yer Şekilleri",q:"Türkiye'de en uzun akarsu aşağıdakilerden hangisidir?",o:{"A":"Sakarya Nehri","B":"Fırat Nehri (Kızılırmak)","C":"Kızılırmak","D":"Yeşilırmak","E":"Seyhan Nehri"},a:"C",e:"Kızılırmak, 1355 km ile Türkiye sınırları içinde en uzun akarsudur.",d:"Akarsu sıralaması (yurtiçi): Kızılırmak (1355 km) > Sakarya > Fırat (yurtiçi kısmı). Toplam uzunluk: Fırat en uzun ama büyük kısmı yurt dışında. ÖSYM 'Türkiye sınırları içinde' diye sorar — dikkat!"},
],
vatandaslik:[
...
{t:"Temel Hak ve Özgürlükler",q:"Aşağıdakilerden hangisi 1982 Anayasası'nda düzenlenen sosyal ve ekonomik haklar arasında yer alır?",o:{"A":"Kişi dokunulmazlığı","B":"Seçme ve seçilme hakkı","C":"Eğitim ve öğrenim hakkı","D":"Düşünce ve kanaat özgürlüğü","E":"Dilekçe hakkı"},a:"C",e:"Eğitim ve öğrenim hakkı 'Sosyal ve Ekonomik Haklar' bölümündedir.",d:"Kişi hakları = dokunulmazlık, düşünce, mülkiyet. Sosyal = eğitim, sağlık, çalışma. Siyasi = seçme, dilekçe, parti."},
{t:"Hukukun Temel Kavramları",q:"Aşağıdakilerden hangisi hukuk kurallarının özelliklerinden biri değildir?",o:{"A":"Genellik","B":"Soyutluk","C":"Yaptırım","D":"Süreklilik","E":"İsteğe bağlılık"},a:"E",e:"Hukuk kuralları zorunludur, isteğe bağlı değildir. Yaptırımla desteklenir.",d:"Hukuk kuralları: Genel, soyut, sürekli, zorunlu (emredici), yaptırımlı. Ahlak kuralları ise isteğe bağlı ve manevi yaptırımlıdır."},
{t:"Anayasa Hukuku",q:"1982 Anayasası'na göre TBMM'nin üye sayısı kaçtır?",o:{"A":"450","B":"500","C":"550","D":"600","E":"650"},a:"D",e:"2017 Anayasa değişikliğiyle TBMM üye sayısı 550'den 600'e çıkarılmıştır.",d:"Eski: 550 üye. 2017 sonrası: 600 üye. Seçilme yaşı: 18 (2017 değişikliği ile 25'ten 18'e düşürüldü). Bu rakamlar KPSS'de doğrudan sorulur."},
{t:"Yasama",q:"TBMM'de kanun teklifinde bulunma yetkisi kime aittir?",o:{"A":"Cumhurbaşkanına","B":"Bakanlara","C":"Milletvekillerine","D":"Anayasa Mahkemesine","E":"Danıştaya"},a:"C",e:"2017 sonrası kanun teklif etme yetkisi yalnızca milletvekillerine aittir.",d:"2017 öncesi: Bakanlar Kurulu 'tasarı', milletvekilleri 'teklif' sunardı. 2017 sonrası: Sadece milletvekilleri 'teklif' sunabilir. Cumhurbaşkanı kanun teklif edemez — sadece onaylar veya geri gönderir."},
{t:"Yürütme",q:"Cumhurbaşkanlığı Kararnamesi ile aşağıdaki konulardan hangisi düzenlenemez?",o:{"A":"Bakanlıkların kurulması","B":"Üst düzey kamu görevlilerinin atanması","C":"Temel haklar ve ödevler","D":"Devlet teşkilatının düzenlenmesi","E":"Milli güvenlik politikalarının belirlenmesi"},a:"C",e:"CBK ile temel haklar, kişi hakları ve siyasi haklar düzenlenemez; bunlar ancak kanunla düzenlenir.",d:"CBK sınırları: Temel haklar, suç-ceza konuları, bütçe kanunla düzenlenmesi gereken konularda CBK çıkarılamaz. Bu kural 2017 sistemi'nin önemli dengesidir."},
{t:"Yargı",q:"Danıştay'ın temel görevi aşağıdakilerden hangisidir?",o:{"A":"Ceza davalarına bakmak","B":"İdari yargının en üst mahkemesi olarak idari davaları incelemek","C":"Anayasaya uygunluk denetimi yapmak","D":"Seçimleri yönetmek","E":"Milletvekilliği dokunulmazlığını kaldırmak"},a:"B",e:"Danıştay, idari yargının en üst mahkemesidir ve idari davaların temyiz merciidir.",d:"Yüksek mahkeme görev dağılımı: Yargıtay = adli yargı üst. Danıştay = idari yargı üst. AYM = anayasaya uygunluk. YSK = seçim. Uyuşmazlık Mah. = yargı yolu uyuşmazlığı."},
{t:"İdare Hukuku",q:"Aşağıdakilerden hangisi merkezden yönetimin özelliklerinden biridir?",o:{"A":"Yerel halkın yönetime katılımı","B":"Karar alma yetkisinin yerel birimlere bırakılması","C":"Kamu hizmetlerinin tek merkezden yönetilmesi","D":"Belediye başkanlarının bağımsız karar alması","E":"İl özel idarelerinin özerk olması"},a:"C",e:"Merkezden yönetimde kararlar merkezi hükümet tarafından alınır ve uygulanır.",d:"Merkezden yönetim = merkezi hükümet karar alır (bakanlıklar, valilikler). Yerinden yönetim = yerel organlar karar alır (belediye, il özel idaresi, köy). Vali = merkezin temsilcisi, belediye başkanı = seçimle gelen yerel yönetici."},
{t:"Temel Hak ve Özgürlükler",q:"1982 Anayasası'na göre temel hak ve özgürlüklerin özüne dokunulamayacağını ifade eden ilke aşağıdakilerden hangisidir?",o:{"A":"Ölçülülük ilkesi","B":"Öze dokunma yasağı","C":"Demokratik toplum düzeni","D":"Laik devlet ilkesi","E":"Hukuk devleti ilkesi"},a:"B",e:"Öze dokunma yasağı, hakların sınırlandırılmasında bile özün korunması gerektiğini ifade eder.",d:"Sınırlama ilkeleri: Kanunla, meşru amaç, demokratik topluma uygun, ölçülü, öze dokunmama."},
{t:"Anayasa Hukuku",q:"1982 Anayasası'na göre Cumhurbaşkanının görev süresi kaç yıldır?",o:{"A":"4","B":"5","C":"6","D":"7","E":"8"},a:"B",e:"Cumhurbaşkanının görev süresi 5 yıldır ve en fazla iki dönem seçilebilir.",d:"CB görev süresi = 5 yıl. En fazla 2 dönem. 2017 değişikliğiyle parti üyeliği devam edebilir. Seçim: Halk tarafından, mutlak çoğunluk (ilk turda %50+1 olmazsa ikinci tur)."},
{t:"Yasama",q:"TBMM kararları için aşağıdakilerden hangisi genel karar yeter sayısıdır?",o:{"A":"Toplantıya katılanların salt çoğunluğu","B":"Üye tamsayısının salt çoğunluğu","C":"Üye tamsayısının 2/3'ü","D":"Üye tamsayısının 3/5'i","E":"Toplantıya katılanların 2/3'ü"},a:"A",e:"Genel kural: TBMM, toplantıya katılanların salt çoğunluğuyla karar alır; ancak karar yeter sayısı üye tamsayısının 1/4'ünden az olamaz.",d:"Toplantı yeter sayısı = üye tamsayısının 1/3'ü (200 mv). Karar yeter sayısı = toplantıya katılanların salt çoğunluğu, ama en az 1/4 (150 mv). Anayasa değişikliği ve özel durumlar için daha yüksek oranlar gerekir."},
],
};

// ─── DEMO QUESTION COMPONENT ───
function DemoQuestion({onStart}){
  const [sel,setSel]=useState(null);
  const [show,setShow]=useState(false);
  const q={q:"Aşağıdakilerden hangisi Osmanlı Devleti'nde Divan-ı Hümayun'un ilk kurulduğu dönemdir?",o:{"A":"Osman Bey dönemi","B":"Orhan Bey dönemi","C":"I. Murad dönemi","D":"Fatih dönemi","E":"Yıldırım Bayezid dönemi"},a:"B",e:"Divan-ı Hümayun Orhan Bey döneminde kurulmuştur. Fatih döneminde divan başkanlığı sadrazama devredilmiştir."};
  const pick=(l)=>{if(show)return;setSel(l);setShow(true);};
  return(
    <div style={{border:"0.5px solid var(--color-border-tertiary)",borderRadius:12,padding:"16px",background:"var(--color-background-primary)"}}>
      <div style={{display:"inline-block",fontSize:11,fontWeight:500,color:"#854F0B",background:"#FAEEDA",borderRadius:6,padding:"3px 8px",marginBottom:10}}>Tarih</div>
      <div style={{fontSize:14,lineHeight:1.6,marginBottom:14,fontWeight:500}}>{q.q}</div>
      <div style={{display:"flex",flexDirection:"column",gap:6}}>
        {Object.entries(q.o).map(([l,txt])=>{
          let bdr="var(--color-border-tertiary)",bg="var(--color-background-primary)",col="var(--color-text-primary)";
          if(show){if(l===q.a){bdr="var(--color-border-success)";bg="var(--color-background-success)";col="var(--color-text-success)";}else if(l===sel){bdr="var(--color-border-danger)";bg="var(--color-background-danger)";col="var(--color-text-danger)";}}
          return(<div key={l} onClick={()=>pick(l)} style={{display:"flex",alignItems:"center",gap:8,padding:"10px 12px",borderRadius:8,border:`0.5px solid ${bdr}`,background:bg,cursor:show?"default":"pointer"}}>
            <span style={{fontWeight:500,fontSize:13,color:show?col:"var(--color-text-secondary)",minWidth:18}}>{l})</span>
            <span style={{fontSize:13,color:show?col:"var(--color-text-primary)"}}>{txt}</span>
          </div>);
        })}
      </div>
      {show&&(<div style={{marginTop:12}}>
        <div style={{padding:"10px 12px",borderRadius:8,background:"var(--color-background-secondary)",fontSize:12,lineHeight:1.5,color:"var(--color-text-secondary)",marginBottom:10}}>{q.e}</div>
        <button onClick={onStart} style={{width:"100%",padding:"10px",borderRadius:8,cursor:"pointer",fontSize:13,fontWeight:500,background:"#EEEDFE",color:"#534AB7",border:"none"}}>Daha fazla soru çöz →</button>
      </div>)}
    </div>
  );
}
...
function App(){
  const [showLanding,setShowLanding]=useState(()=>{try{return !localStorage.getItem("kpss_visited")}catch(e){return true}});
  useEffect(()=>{
  ...
  const enterApp=()=>{try{localStorage.setItem("kpss_visited","1")}catch(e){}setShowLanding(false)};
  const totalQCount=Object.values(Q).reduce((s,v)=>s+v.length,0);

  // ── LANDING PAGE ──
  if(showLanding)return(
    <div style={{maxWidth:600,margin:"0 auto",padding:"1rem 0"}}>
      {/* Hero */}
      <div style={{textAlign:"center",padding:"2.5rem 0 2rem"}}>
        <div style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:56,height:56,borderRadius:16,background:"linear-gradient(135deg,#534AB7,#185FA5)",marginBottom:16}}>
          <span style={{color:"#fff",fontFamily:"Georgia,serif",fontSize:24,fontWeight:700}}>K</span>
        </div>
        <div style={{fontFamily:"Georgia,serif",fontSize:32,fontWeight:500,letterSpacing:"-0.8px",marginBottom:8}}>KPSSBot</div>
        <div style={{fontSize:13,color:"#534AB7",background:"#EEEDFE",display:"inline-block",borderRadius:20,padding:"4px 14px",marginBottom:16,fontWeight:500}}>Yapay zeka destekli KPSS hazırlık</div>
        <div style={{fontSize:16,color:"var(--color-text-secondary)",maxWidth:400,margin:"0 auto 24px",lineHeight:1.6}}>
          ÖSYM formatında sorular, detaylı açıklamalar, zayıf konu analizi. Sınavda fark yarat.
        </div>
        <button onClick={enterApp} style={{fontSize:16,padding:"14px 40px",borderRadius:12,cursor:"pointer",background:"var(--color-text-primary)",color:"var(--color-background-primary)",border:"none",fontWeight:500,marginBottom:8}}>Ücretsiz başla</button>
        <div style={{fontSize:12,color:"var(--color-text-tertiary)"}}>Kayıt gerektirmez</div>
      </div>

      {/* Stats */}
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10,marginBottom:24}}>
        {[{v:totalQCount+"+",l:"ÖSYM sorusu"},{v:"5",l:"Ders"},{v:"₺0",l:"Başlangıç"}].map((s,i)=>(
          <div key={i} style={{textAlign:"center",padding:"14px 8px",background:"var(--color-background-secondary)",borderRadius:12}}>
            <div style={{fontSize:22,fontWeight:500,marginBottom:2}}>{s.v}</div>
            <div style={{fontSize:12,color:"var(--color-text-secondary)"}}>{s.l}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{marginBottom:24}}>
        <div style={{textAlign:"center",fontWeight:500,fontSize:18,marginBottom:14}}>Neden KPSSBot?</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(2,minmax(0,1fr))",gap:10}}>
          {[
            {i:"📝",t:"ÖSYM formatı",d:"Gerçek sınav kalıbında sorular ve inandırıcı çeldiriciler"},
            {i:"📊",t:"Zayıf konu analizi",d:"Hangi konuda takıldığını tespit edip uyarır"},
            {i:"⏱",t:"Süre takibi",d:"Her soruya harcadığın zamanı ölçer, KPSS temponu tutar"},
            {i:"📕",t:"Yanlış defteri",d:"Yanlışların otomatik kaydedilir, sonra tekrar çözersin"},
            {i:"⭐",t:"XP ve seviye",d:"Soru çözdükçe XP kazan, seviye atla, motivasyonunu koru"},
            {i:"📐",t:"Karalama tahtası",d:"Matematik sorularını parmağınla çöz, kâğıt kalem gereksiz"},
          ].map((f,i)=>(
            <div key={i} style={{padding:"14px",borderRadius:12,border:"0.5px solid var(--color-border-tertiary)",background:"var(--color-background-primary)"}}>
              <div style={{fontSize:20,marginBottom:6}}>{f.i}</div>
              <div style={{fontWeight:500,fontSize:13,marginBottom:2}}>{f.t}</div>
              <div style={{fontSize:12,color:"var(--color-text-secondary)",lineHeight:1.4}}>{f.d}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Subjects preview */}
      <div style={{marginBottom:24}}>
        <div style={{textAlign:"center",fontWeight:500,fontSize:18,marginBottom:14}}>5 ders, {totalQCount}+ soru</div>
        <div style={{display:"flex",flexDirection:"column",gap:6}}>
          {Object.entries(SUBJECTS).map(([k,sub])=>(
            <div key={k} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 14px",borderRadius:10,border:"0.5px solid var(--color-border-tertiary)",background:"var(--color-background-primary)"}}>
              <div style={{width:32,height:32,borderRadius:8,background:sub.bg,display:"flex",alignItems:"center",justifyContent:"center",fontSize:15}}>{sub.icon}</div>
              <div style={{flex:1,fontSize:14,fontWeight:500}}>{sub.name}</div>
              <div style={{fontSize:12,color:"var(--color-text-secondary)"}}>{(Q[k]||[]).length} soru</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Demo question */}
      <div style={{marginBottom:24}}>
        <div style={{textAlign:"center",fontWeight:500,fontSize:18,marginBottom:14}}>Hemen dene</div>
        <DemoQuestion onStart={enterApp}/>
      </div>

      {/* CTA */}
      <div style={{textAlign:"center",padding:"2rem 1rem",borderRadius:16,background:"var(--color-background-secondary)",marginBottom:16}}>
        <div style={{fontWeight:500,fontSize:18,marginBottom:6}}>Hazır mısın?</div>
        <div style={{fontSize:14,color:"var(--color-text-secondary)",marginBottom:16}}>Her gün çözmediğin soru, sınavda karşına çıkar.</div>
        <button onClick={enterApp} style={{fontSize:15,padding:"12px 32px",borderRadius:10,cursor:"pointer",background:"var(--color-text-primary)",color:"var(--color-background-primary)",border:"none",fontWeight:500}}>Ücretsiz başla</button>
      </div>

      <div style={{textAlign:"center",fontSize:12,color:"var(--color-text-tertiary)",paddingBottom:16}}>KPSSBot — Yapay zeka destekli KPSS hazırlık platformu</div>
    </div>
  );
